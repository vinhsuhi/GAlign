...
//        );
    ...
    public void Train() throws IOException {
        IONEUpdate twoOrder_x =
                new IONEUpdate(dim, networkx_file, postfix1, random, rho_init);
        twoOrder_x.init();

        IONEUpdate twoOrder_y =
                new IONEUpdate(dim, networky_file, postfix2, random, rho_init);
        twoOrder_y.init();
...
//        twoOrder_y.output(output_filename_networky);
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length >= 10) rho_init = Double.parseDouble(args[9]);
