...
public class IONEUpdate {
    ...
    public IONEUpdate(int dim, String filename, String postfix_string, Random random, double rho_init) {
        ...
        while (temp_string != null) {
            ...
            if (vertex.containsKey(array[0])) {
                ...
                for (int i = 0; i < dimension; i++) {
                    emb_vertex[i] = (random.nextDouble() - 0.5) / dimension;
    ...
    public void Train(int i,
        ...
        for (int d = 0; d < num_negative + 1; d++) {
            if (d == 0) {
                ...
                int neg_index = (int) (neg_table_size * random.nextDouble());
