...
IsoRank \
--max_iter 30 \
--alpha 0.82 > log/isorank/erdos-renyi-n1000-p2
...
IsoRank \
--max_iter 30 \
--alpha 0.82 > log/isorank/erdos-renyi-n10000-p05
...
IsoRank \
--max_iter 30 \
--alpha 0.82 > log/isorank/erdos-renyi-n10000-p1
...
IsoRank \
--max_iter 30 \
--alpha 0.82 > log/isorank/erdos-renyi-n10000-p2
...
IsoRank \
--max_iter 30 \
--alpha 0.82 > log/isorank/erdos-renyi-n10000-p3