...
def main(args):
    ...
    copyfile(input_folder + "id2idx.json", args.output1 + "id2idx.json")
    copyfile(input_folder + "id2idx.json", args.output2 + "id2idx.json")

    if os.path.exists(args.input + "-feats.npy"):
        copyfile(input_folder + "feats.npy", args.output1 + "feats.npy")
        copyfile(input_folder + "feats.npy", args.output2 + "feats.npy")
