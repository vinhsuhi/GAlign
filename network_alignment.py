...
def parse_args():
    ...
    # NAWAL
    parser_nawal = subparsers.add_parser('IsoRank', help='IsoRank algorithm')
    ...
    parser_nawal.add_argument('--nawal_mapping_batch_size', type=int)
    parser_nawal.add_argument('--dis_smooth', type=float)
    parser_nawal.add_argument('--min_lr', type=float)
    parser_nawal.add_argument('--lr_decay', type=float)
    parser_nawal.add_argument('--lr_shrink', type=float)
    parser_nawal.add_argument('--embedding_dim', type=int)
    parser_nawal.add_argument('--dis_hid_dim', type=int)
    parser_nawal.add_argument('--dis_layers', type=int)
    parser_nawal.add_argument('--dis_dropout', type=float)
    parser_nawal.add_argument('--dis_input_dropout', type=float)
    parser_nawal.add_argument('--map_optimizer')
    parser_nawal.add_argument('--dis_optimizer')
    parser_nawal.add_argument('--nawal_mapping_epochs', type=int)
    parser_nawal.add_argument('--nawal_mapping_epoch_size', type=int)
    parser_nawal.add_argument('--test_dict', type=str)
    parser_nawal.add_argument('--train_dict', type=str)
    parser_nawal.add_argument('--map_beta', type=float)
